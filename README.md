# @zitterorg/dolor-placeat

[![npm version](https://badge.fury.io/js/@zitterorg/dolor-placeat.svg)](https://badge.fury.io/js/@zitterorg/dolor-placeat)
[![downloads count](https://img.shields.io/npm/dt/@zitterorg/dolor-placeat.svg)](https://www.npmjs.com/package/@zitterorg/dolor-placeat)
[![github-ci](https://github.com/zitterorg/dolor-placeat/actions/workflows/testing.yml/badge.svg)](https://github.com/zitterorg/dolor-placeat/actions/workflows/testing.yml)
...
Next, install `@zitterorg/dolor-placeat`:

```bash
npm install -D @zitterorg/dolor-placeat
```
